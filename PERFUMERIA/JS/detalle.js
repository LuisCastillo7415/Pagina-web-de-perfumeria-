document.addEventListener("DOMContentLoaded", function() {
    ...
    if (!idPerfume) {
        document.getElementById("detalle-producto").innerHTML = "<p>Perfume no encontrado</p>";
        return;
    }
    ...
    fetch(`http://localhost/PERFUMERIA/obtener_perfume.php?id=${idPerfume}`)
        ...
        .catch(error => {
            ...
            document.getElementById("detalle-producto").innerHTML = "<p>Error al cargar el perfume</p>";
        });
});
